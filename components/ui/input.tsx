    ...
    return (
      <div className="w-full">
        {label && (
          <label
            htmlFor={id}
            className="block text-sm font-semibold text-[#28201A] mb-1.5 font-body"
          >
            {label}
          </label>
        )}
        <input
          ...
          id={id}
          className={cn(
            'w-full rounded-xl border border-[#DDD0B8] bg-white px-4 py-3 text-[#28201A] text-base font-body',
