...
export default function ProfilPage() {
  ...
  return (
    <div className="pb-12 max-w-xl mx-auto">
      <h1 className="font-heading text-3xl text-[#73605a] mb-8">Mein Profil</h1>

      <div className="bg-white border border-[#DDD0B8] rounded-2xl p-6 mb-6 space-y-4">
        <div className="flex items-center gap-3">
          <Mail size={16} className="text-[#7B60B4]" />
          <span className="text-sm text-[#73605a] font-body">{firebaseUser?.email}</span>
        </div>
        {appUser?.displayName && (
          <div className="flex items-center gap-3">
            <span className="text-sm text-[#73605a] font-body font-semibold">{appUser.displayName}</span>
          </div>
        )}
      </div>
      ...
      <div className="bg-white border border-[#DDD0B8] rounded-2xl p-6 mb-6">
        <h2 className="font-heading text-xl text-[#73605a] mb-4">Kursfortschritt</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-[#73605a] font-body">{totalLessons}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-[#73605a] font-body">{completedCount}</p>
            </div>
          </div>
        </div>
      </div>
