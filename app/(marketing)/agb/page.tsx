...
export default function AgbPage() {
  return (
    <div className="pt-24 px-6 pb-20 max-w-3xl mx-auto">
      <h1 className="font-heading text-4xl text-[#73605a] mb-8">Allgemeine Geschäftsbedingungen</h1>
      <div className="text-sm text-[#7A6C60] font-body leading-relaxed space-y-6">
        <section>
          <h2 className="font-heading text-xl text-[#73605a] mb-3">1. Geltungsbereich</h2>
          <p>
        ...
        <section>
          <h2 className="font-heading text-xl text-[#73605a] mb-3">2. Vertragsschluss</h2>
          <p>
            Mit dem Kauf des Kurses kommt ein Vertrag zwischen dir und der Anbieterin zustande.
          </p>
        </section>
        <section>
          <h2 className="font-heading text-xl text-[#73605a] mb-3">3. Nutzungsrecht</h2>
          <p>
