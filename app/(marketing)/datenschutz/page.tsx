...
export default function DatenschutzPage() {
  return (
    <div className="pt-24 px-6 pb-20 max-w-3xl mx-auto">
      <h1 className="font-heading text-4xl text-[#28201A] mb-8">Datenschutzerklärung</h1>
      <div className="text-sm text-[#7A6C60] font-body leading-relaxed space-y-6">
        <section>
          <h2 className="font-heading text-xl text-[#28201A] mb-3">1. Datenschutz auf einen Blick</h2>
          <p>
        ...
        <section>
          <h2 className="font-heading text-xl text-[#28201A] mb-3">2. Datenerfassung auf dieser Website</h2>
          <p>
        ...
        <section>
          <h2 className="font-heading text-xl text-[#28201A] mb-3">3. Firebase & Hosting</h2>
          <p>
        ...
        <section>
          <h2 className="font-heading text-xl text-[#28201A] mb-3">4. Deine Rechte</h2>
          <p>
